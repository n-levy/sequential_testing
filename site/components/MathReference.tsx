          ...
          <table className="w-full text-sm border-collapse border border-neutral-300">
            ...
            <tbody>
              {[
                ...
                ['t_k', 'Information fraction at peek k: t_k = k/K', 'Act 3 (OBF)'],
                ['Z_k', 'z-statistic at peek k: \\hat{\\tau}/\\text{SE}', 'Act 3'],
                ['z_{\\alpha/2}', 'Standard Normal critical value (\\approx 1.96)', 'Throughout'],
