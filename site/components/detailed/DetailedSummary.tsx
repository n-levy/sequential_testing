        ...
        <div className="overflow-x-auto mb-8">
          <table className="w-full min-w-[640px] text-sm border-collapse border border-neutral-300">
            ...
            <tbody>
              ...
              <tr><td className="border border-neutral-300 p-3">10</td><td className="border border-neutral-300 p-3">Eppo (2022) pipeline</td><td className="border border-neutral-300 p-3">Statistical pipeline</td><td className="border border-neutral-300 p-3">Randomise &rarr; adjust &rarr; CI &rarr; decide</td></tr>
              ...
              <tr><td className="border border-neutral-300 p-3">12</td><td className="border border-neutral-300 p-3">Eppo&apos;s (2022) sequential CI</td><td className="border border-neutral-300 p-3">Final output</td><td className="border border-neutral-300 p-3">Sequential multiplier; decide anytime</td></tr>
              <tr className="bg-neutral-50"><td className="border border-neutral-300 p-3">13</td><td className="border border-neutral-300 p-3">DIY alternatives</td><td className="border border-neutral-300 p-3">Simple approximations</td><td className="border border-neutral-300 p-3">Bonferroni, Pocock, OBF vs. Eppo (2022)</td></tr>
            </tbody>
          </table>
        </div>
