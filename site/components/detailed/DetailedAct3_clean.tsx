...
export function DetailedAct3() {
	return (
		<section id="act-3" className="py-16 bg-white">
			<div className="max-w-4xl mx-auto px-4">
				<div className="text-center mb-12">
					<h2 className="text-3xl font-bold text-neutral-900 mb-4">
						Act 3 &mdash; The Gambling Game and the Martingale
					</h2>
				</div>
				...
				<div className="text-neutral-700 space-y-3 mb-6">
					<p>
						<InlineMath>{`\\tau`}</InlineMath> is a decision rule of the form: “Stop
				...
				<h4 className="text-lg font-semibold text-neutral-800 mb-3">
					The “reasonable conditions” for Doob's theorem
				</h4>
				<div className="text-neutral-700 space-y-3 mb-6">
				...
				<div className="text-neutral-700 space-y-3 mb-6">
					...
					<ul className="list-disc ml-6 space-y-1">
						<li>Finite budget ⇒ real probability of ruin before recovery.</li>
