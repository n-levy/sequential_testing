    ...
    <section id="references" className="py-16 bg-neutral-50">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <ol className="space-y-6 text-neutral-700">
          <li id="ref-ville-1939" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-wald-1945" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-wald-wolfowitz-1948" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-doob-1953" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-robbins-1970" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-pocock-1977" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-obrien-fleming-1979" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-deng-2013" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-johari-2017" className="border-l-4 border-blue-300 pl-4">
          ...
          <li id="ref-howard-2021" className="border-l-4 border-blue-300 pl-4">
