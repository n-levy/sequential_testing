      ...
      <div className="bg-white border border-neutral-200 rounded-lg p-5">
        ...
        {data && (
          <div className="grid grid-cols-4 gap-3 mt-4">
            ...
            <div className={`border rounded-lg p-3 text-center ${data.significant ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}>
              <div className={`text-sm font-bold ${data.significant ? 'text-green-700' : 'text-red-700'}`}>
